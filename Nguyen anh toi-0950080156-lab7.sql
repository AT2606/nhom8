...
-------bai1------
-- a.Nhap vao MaNV cho biet tuoi cua nhan vien
...
----b.Nhap vao Manv cho biet so luong de an nhan vien nay da tham gia--
...
---c.Truyen tham so vao phai nam hoac nu, xuat so luong nhann vien theo phai--
...
----d.Truyền tham số đầu vào là tên phòng, tính mức lương trung bình của phòng đó, Cho biết 
...
--e.Tryền tham số đầu vào là Mã Phòng, cho biết tên phòng ban, họ tên người trưởng phòng và số lượng đề án mà phòng ban đó chủ trì.
...
------------bai2----
-----a.Hiển thị thông tin HoNV,TenNV,TenPHG, DiaDiemPhg.
...
----b.Hiển thị thông tin TenNv, Lương, Tuổi
...
----c. Hiển thị tên phòng ban và họ tên trưởng phòng của phòng ban có đông nhân viên nhất
