...
insert lop values('a','lop a',0),
insert lop values('b','lop b',0),
insert lop values('c','lop c',0)
insert sinhvien values('01','anh toi','1999-1-1','a'),
insert sinhvien values('02','nguyen anh','1999-11-1','a'),
insert sinhvien values('03','le phuong','1999-12-12','a')
insert monhoc values('PPLT','Phuong phap LT'),
insert monhoc values('CSDL','Co so du lieu'),
insert monhoc values('SQL','He quan tri CSDL'),
insert monhoc values('PTW','Phat trien Web')
insert KetQua values('01','PPLT',8),
insert KetQua values('01','SQL',7),
insert KetQua values('02','PPLT',8),
insert KetQua values('01','CSDL',5),
insert KetQua values('02','PTW',5)
...
go
select dbo.diemtb ('02')
--2.Viết hàm bằng 2 cách (table – value fuction và multistatement value function) tính điểm trung bình của cả lớp,
--thông tin gồm MaSV, Hoten, ĐiemTB, sử dụng hàm diemtb ở câu 1
go
--cách 1
...
--3.Viết một thủ tục kiểm tra một sinh viên đã thi bao nhiêu môn, tham số là MaSV, (VD sinh viên có MaSV=01 thi 3 môn) 
--kết quả trả về chuỗi thông báo “Sinh viên 01 thi 3 môn” hoặc “Sinh viên 01 không thi môn nào”
go
