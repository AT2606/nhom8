...
END
  INSERT INTO NHANVIEN VALUES (N'Nguyễn', N'Anh' , N'Tới', '010' , N'2002/06/26' , N'148 ton dan, Tp HCM', N'Nam', 100, '005' ,1 )

  ---------------CAU 2---------
create trigger ThemNV2 ON NHANVIEN FOR INSERT AS
DECLARE @age int
...
if (@age <18 and @age >65)
    BEGIN
		...
		ROLLBACK TRANSACTION
END
  INSERT INTO NHANVIEN VALUES (N'Nguyễn', N'Anh' , N'Tới', '011' , N'2010/06/26' , N'148 ton dan, Tp HCM', N'Nam', 100, '005' ,1 )

  ---------------CAU 3---
create trigger update_nv4 ON NHANVIEN FOR UPDATE AS
if (SELECT DChi from inserted)like '%TP.HCM%'
    BEGIN
		PRINT 'ko duoc cap nhat nhan vien o tphcm'
		ROLLBACK TRANSACTION
	END
UPDATE NHANVIEN SET TENNV ='toi' where MANV ='004'
...
END
  INSERT INTO NHANVIEN VALUES (N'Nguyễn', N'Anh' , N'Tới', '018' , N'2002/06/26' , N'148 ton dan, Tp HCM', N'Nam', 100, '005' ,1 )
 select* from NHANVIEN
 ------------CAU2----------
...
END
  ...
  -----------Cau2---------- 
create trigger kkewee1  ON NHANVIEN after insert AS
BEGIN
		insert into PHANCONG values((select MANV from inserted),1,1,123)
END
INSERT INTO NHANVIEN VALUES (N'Nguyễn', N'Anh' , N'Tới', '011' , N'2002/06/26' , N'148 ton dan, Tp HCM', N'Nam', 100, '005' ,1 )
